...
3. Ejecutar curl:
   ...
   ```
4. **Verificar**:
   - [SI] Status code: 200 OK
   - [SI] Devuelve lista de servicios
   - [SI] Usuario autenticado correctamente
...
5. Intentar usar TOKEN_1 nuevamente:
   ...
   ```
6. **Verificar**:
   - [SI] Status code: 401 Unauthorized
   - [SI] Mensaje: "Token inválido o expirado"
   - [SI] TOKEN_1 ya no funciona ⭐
...
8. **Verificar**:
   - [SI] Status code: 200 OK
   - [SI] TOKEN_2 funciona correctamente ✅
...
1. Ejecutar curl sin header Authorization:
   ...
   ```
2. **Verificar**:
   - [SI] Statuºs code: 401 Unauthorized
   - [SI] Mensaje de error apropiado
...
1. Con token de Usuario B, intentar acceder a servicio de Usuario A:
   ...
   ```
2. **Verificar**:
   - [SI] Status code: 404 Not Found o 403 Forbidden
   - [SI] No se muestra información del servicio
...
6. **Verificar**:
   - [SI] Status code: 401 Unauthorized
   - [SI] Token eliminado ya no funciona
...
- [SI] Tokens revocables funcionan correctamente
- [SI] Regenerar token invalida el anterior INMEDIATAMENTE
- [SI] Tokens modificados son rechazados
- [SI] Sin token = sin acceso
- [SI] Permisos de usuario funcionan correctamente
- [SI] Admin puede revocar tokens

### **Funcionalidad:**

- [SI] API funciona correctamente con tokens válidos
